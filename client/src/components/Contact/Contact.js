    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col justify-between items-center">
          {/* text */}
          <div class="flex flex-col md:flex-row items-center md:items-start pt-12 text-center xl:text-left">
            <div class="mb-4 md:mr-4">
              <img class="w-12 h-12" src={logo} alt="" />
            </div>
            <h2 class=" font-primary text-lg md:text-xl lg:text-2xl xl:text-3xl" data-aos="fade-up" data-aos-delay="300">
              {title}
            </h2>
          </div>
          <br/>
          ...
          <div className="flex flex-col xl:flex-row gap-y-4 gap-x-[30px]">
            ...
            <a href="https://wa.me/917448408684?text=Hey%20Young%20Visionaries.%20I%27m%20interested%20to%20avail%20your%20services."
              class="btn btn-primary flex items-center gap-x-2 group hover:text-white text-base md:text-lg lg:text-xl xl:text-2xl"
              data-aos="fade-up"
              data-aos-delay="400"
            >
              Contact Us
              <BsArrowRight class="text-xl text-accent-quaternary group-hover:text-white transition" />
            </a>
              ...
              {socialList.map((item, index) => {
                return (
                  <div key={index} className="flex flex-row items-center space-x-2">
                    ...
                    <a
                      class="lead text-base md:text-lg lg:text-xl xl:text-xl"
                      data-aos="fade-up"
                      data-aos-delay={item.delay}
                      href="mailto:brightknights05@gmail.com?subject=Service%20Enquiry%20-%20%5BYour%20Name%5D&body=Hey%20Young%20Visionaries%0A%0AI'm%20interested%20in%20availing%20your%20services."
                    >
                      {item.mailid}
                    </a>
                  </div>
